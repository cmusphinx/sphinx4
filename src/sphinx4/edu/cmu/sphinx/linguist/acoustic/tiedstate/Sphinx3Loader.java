...
public class Sphinx3Loader implements Loader {
    ...
    public Sphinx3Loader(URL location, String model, String dataLocation,
        ...
        init(location, model, dataLocation, logMath, unitManager, isBinary, sparseForm, vectorLength, distFloor, mixtureWeightFloor, varianceFloor, useCDUnits, Logger.getLogger(getClass().getName()));
    }
    ...
    public Sphinx3Loader(String location, String model, String dataLocation,
        ...
        init(ConfigurationManagerUtils.resourceToURL(location), model, dataLocation, logMath, unitManager, isBinary, sparseForm, vectorLength, distFloor, mixtureWeightFloor, varianceFloor, useCDUnits, Logger.getLogger(getClass().getName()));
    }
    ...
    private void loadModelFiles(String modelDef) throws IOException, URISyntaxException {
        ...
        if (binary) {
            meansPool = loadDensityFileBinary(dataLocation + "means",
                    -Float.MAX_VALUE);
            variancePool = loadDensityFileBinary(dataLocation + "variances",
                    varianceFloor);
            mixtureWeightsPool = loadMixtureWeightsBinary(dataLocation
                    + "mixture_weights", mixtureWeightFloor);
            matrixPool = loadTransitionMatricesBinary(dataLocation
                    + "transition_matrices");
            transformMatrix = loadTransformMatrix(dataLocation + "feature_transform");
        } else {
            meansPool = loadDensityFileAscii(dataLocation + "means.ascii",
                    -Float.MAX_VALUE);
            variancePool = loadDensityFileAscii(dataLocation + "variances.ascii",
                    varianceFloor);
            mixtureWeightsPool = loadMixtureWeightsAscii(dataLocation
                    + "mixture_weights.ascii", mixtureWeightFloor);
            matrixPool = loadTransitionMatricesAscii(dataLocation
