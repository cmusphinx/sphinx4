 ...
 * Should work OOTB with old sphinx code
 * 
...
public class LargeTrigramModel extends LargeNGramModel {
	...
	public LargeTrigramModel(String format, URL urlLocation,
			String ngramLogFile, int maxTrigramCacheSize, int maxBigramCacheSize,
			boolean clearCacheAfterUtterance, int maxDepth, LogMath logMath,
			Dictionary dictionary, boolean applyLanguageWeightAndWip,
		...
		super(format, urlLocation, ngramLogFile, maxTrigramCacheSize,
				maxBigramCacheSize, clearCacheAfterUtterance, (maxDepth > 3 ? 3 : maxDepth),
