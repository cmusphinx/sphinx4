...
/**
 * Manages configuration data for sphinx.  Configuration data in Sphinx is managed via property files. Objects that need
 * configuration data should get the SphinxProperties object for their context and extract properties. Property names
 * have the form:
 * <p/>
 * objectName.propertyName
 * <p/>
 * There is a hierarchy of Configuration  data. When a getProperty method is called on a SphinxProperties object, the
 * System properties are checked first to see if there is a property with the given name, if so, the system property is
 * used, otherwise the properties associated with the URL are checked and if found that is used, otherwise the default
 * value for the property is used.
 */
public class SphinxProperties {


    /**
     * The context pool contains a mapping from the context to either the URL for the context or once the properties has
     * been loaded from the URL, the properties object itself
     */
    ...
    /**
     * Initialize a particular context. There can be multiple contexts in a Sphinx system. Each context can have its own
     * SphinxProperties. This method associates a URL with a particular context.
     *
     * @param context the name of the context
     * @param url     the location of the property sheet, or null if there is no property sheet.
     * @throws IOException if the property list cannot be loaded from the given url
     */
     ...
     * @return the SphinxProperties associated with the context. If the given context does not exist an empty
     *         SphinxProperties is returned
     */
    ...
    /**
     * Contructs a new SphinxProperties from the given URL and contextName.
     *
     * @param contextName the name of the context
     * @param url         the url associated with the context (or null)
     * @throws IOException if there was an error loading the property sheet.
     */
    ...
    /**
     * Prints the list of unused properties to the specified stream. Unused properties are properties that were defined
     * in the property list or in the system environment but were never used by the system. They are potentially
     * mispellings or properties that are no longer used. They almost always indicate that some sort of error has taken
     * place.
     *
     * @param out an output stream.
     */
     ...
     *
     * @return a new Property object of all the properties of this SphinxProperties
     */
     ...
     * @return the value of the property, or null if the property does not exists
     */
    ...
    /**
     * Searches for the property with the specified name of a particular instance.  This is a conveniance method, since
     * many property accesses are built by concatenating the instance name and the property name, this method is
     ...
     * @param defaultValue the value to return if the property is not found
     * @return the value of the property
     * @throws NumberFormatException if the property cannot be converted to the number format
     */
    ...
    /**
     * Searches for the property with the specified name. The string values: true, on, 1 and enabled all correspond to
    ...
    /**
     * Returns true if the given string is either "true", "on", "1", or "enabled" (case ignored).
     *
    ...
    /**
     * Prints out a warning to System.out saying that the given property does not exist and is using the given default
     * value.
     *
