...
/**
 * This class stores all the configuration information to be written to output and the properties loaded from input file
 * It does not create any HashMap instances, so these responsibilites are on the creator and be careful when modifying
 * the globalProperties and propertyMap because the original data would also be modified
 *
 * @author Ariani
 */
public class ConfigProperties {
     ...
     *
     * @param p <code>Map</code> of properties with key-value of String name,RawPropertyData
     */
