...
public class XMLConfigReader implements GUIReader {
    ...
    */
    ...
    /**
     * This class uses Singleton pattern for the constructor to make sure that there is only one instance of reader
     * created to get the reader instance, use <code>XMLConfigReader.getInstance()</code>
     */
     ...
     * @throws GUIReaderExceptoin if there are any errors while finding and reading from file.
     */
    ...
    /**
     * Loads the configuration data from the given url and adds the info to the symbol table. Throws an
     * <code>IOexception</code> if there is a problem loading the table. Note that this only performs a partial
     * populating of the symbol table entry
     *
