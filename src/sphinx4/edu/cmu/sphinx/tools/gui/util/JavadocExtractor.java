...
//                System.out.println("commandLine :" + commandLine);
     ...
     * @param class_path  Absolute path to the root of .class files; must end in '\' or '/'
     * @param source_path Absolute path to the source code root directory; must end in '\' or '/'
