...
/**
 * This exception class is thrown when there is an error in the operation of <code>ModelBuilder,
 * ConfigurableComponent</code, and <code>ConfigurableProperty</code>
 *
 * @author Ariani
 */
public class ConfigurableUtilException extends java.lang.Exception {
    ...
    /**
     * Creates a new instance of <code>ConfigurableUtilException</code> with the specific mode that describe the reason,
     * and message
     *
