...
/**
 * This class holds information about one configurable class in the Sphinx model Which includes the classname, property
 * list, class description,group name, and the configuration sets that are defined for this class
 * <p/>
 * This class, combined with <code>ConfigurableProperty</code> construct the Sphinx model.
 * <p/>
...
public class ConfigurableComponent {
    ...
    /** @return Returns the Map that holds the component properties (pair of <code>String, ConfigurableProperty</code>) */
     ...
     *
     * @param name Name of property
     * @return <code>ConfigurableProperty</code> with the specified name; returns null if the property does not exist
     */
     ...
     *
     * @param rpdname  Name of <code>RawPropertyData</code> that stores the property values
     ...
     *
     * @param rpdName  Name of <code>RawPropertyData</code> that holds the configuration values
     * @param propname Property name
     * @return Either a <code>String</code> or <code>List</code> that contains value of the property
     */
    ...
    /**
     * @return <code>Map</code> of <code>RawPropertyData</code> that has all the configuration sets of this component.
     *         Each entry consists of String setname, RawPropertyData setproperties
     */
    ...
    /**
     * check if this component has a <code>RawPropertyData</code> configuration set with specified name
     *
    ...
    /** add all the properties that are in the Configurable Component model, by adding them as default */
    ...
    /**
     * This function is used to create a new configuration set for this type of class The property values are set as
