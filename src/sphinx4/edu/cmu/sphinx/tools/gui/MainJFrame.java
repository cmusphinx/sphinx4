...
/**
 * Holds the main GUI frame Create the GUI tabbed-panels
 *
 * @author Ariani
 */
class MainJFrame extends javax.swing.JFrame {
    ...
    /**
     * Use a JFileChooser in Open mode to select files to open. Then a filter for FileFilter subclass to select for
     * *.config.xml files. If a file is selected then open the file and hand it over to the xml reader
     *
    ...
    /**
     * Use a JFileChooser in Save mode to select files to open. Then a filter for FileFilter subclass to select for
     * ".config.xml" files. If a file is selected, then give it to xml writer for file write
     *
    ...
    */
    ...
    /** helper method to create tab panels based on the groups that are given, one TabPanel for one group */
