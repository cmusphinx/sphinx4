...
public class ModelLoader implements Loader {
    ...
    public void newProperties(PropertySheet ps) throws PropertyException {
        ...
        location = ps.getString(PROP_LOCATION);
        propsFile = getPropsFileDefault(ps);
        dataDir = getDataLocationDefault() + File.separator;
    ...
    private void loadProperties() {
        if (properties == null) {
            ...
            try {
                URL url = new URL("file:" + location + File.separator + propsFile);
     ...
     */
    private String getPropsFileDefault(PropertySheet ps) {
        String propFile = ps.getString(PROP_PROPERTIES_FILE);
        if (propFile != null) {
            return propFile;
        } else {
    ...
    private void loadModelFiles(String modelName) throws IOException {
        ...
        URL url = new URL("file:" + location + File.separator + model);
        logger.info("Loading " + url.getPath());
     ...
     */
    protected DataInputStream readS3BinaryHeader(String location, String path, Properties props)
            throws IOException {

        // System.out.println("resource: " + path + ", " + getClass());
        URL url = new URL("file:" + location + File.separator + path);
        logger.info("Loading " + url.getFile());
        ...
        if (!id.equals("s3")) {
            throw new IOException("Not proper s3 binary file " + url);
        }
        String name;
