 ...
 * <p/>
 * The model.props file is a file of key-value pairs, loadable as a Java Properties file. It should minimally contain
 * the following properties: <ul> <li><b>dataLocation</b> - this specifies the directory where the actual model data
 * files are, <i>relative to the model implementation class</i></li> <li><b>modelDefinition</b> - this specifies the
 * location where the model definition file is, <i>relative to the model implementation class</i></li> </ul> The actual
 * model data files are named "means", "variances", "transition_matrices", "mixture_weights" for binary versions, or
 * prepended with ".ascii" for the ASCII versions. </p>
 * <p/>
