...
public class SphinxRecognizer extends BaseRecognizer {
     ...
     *
     * @throws EngineStateError - if called for an engine in the DEALLOCATED or DEALLOCATING_RESOURCES states.
     * @throws AudioException   if unable to gain acces to the audio channel
     */
     ...
     *
     * @throws EngineException  if an allocation error occurred or the engine is not operational
     * @throws EngineStateError if called for an engine in the DEALLOCATING_RESOURCES state.
     */
    ...
    /**
     * Free the resoures of the engine that were acquired during allocation and operation, and return the engine to the
     * DEALLOCATED state.
     *
     * @throws EngineException  if a deallocation error occurred
     * @throws EngineStateError if called for an engine in the ALLOCATING_RESOURCES state.
     */
