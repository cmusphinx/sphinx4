...
abstract public class BaseEngine implements Engine, SpeechEventDispatcher {
    ...
    /**
     * An <code>Object</code> used for synchronizing access to <code>engineState</code>.
     *
     * @see #engineState
     */
    ...
    /** Creates a new <code>Engine</code> in the <code>DEALLOCATED</code> state. */
    public BaseEngine() {
        this(null);
    }
    ...
    /**
     * Returns a or'ed set of flags indicating the current state of this <code>Engine</code>.
     * <p/>
     * <p>An <code>EngineEvent</code> is issued each time this <code>Engine</code> changes state.
     * <p/>
     * <p>The <code>getEngineState</code> method can be called successfully in any <code>Engine</code> state.
     *
    ...
    /**
     * Blocks the calling thread until this <code>Engine</code> is in a specified state.
     * <p/>
     * <p>All state bits specified in the <code>state</code> parameter must be set in order for the method to return, as
     * defined for the <code>testEngineState</code> method.  If the <code>state</code> parameter defines an unreachable
     * state (e.g. <code>PAUSED | RESUMED</code>) an exception is thrown.
     * <p/>
     * <p>The <code>waitEngineState</code> method can be called successfully in any <code>Engine</code> state.
     *
    ...
    /**
     * Returns <code>true</code> if this state of this <code>Engine</code> matches the specified state.
     * <p/>
     * <p>The test performed is not an exact match to the current state.  Only the specified states are tested.  For
     * example the following returns true only if the <code>Synthesizer</code> queue is empty, irrespective of the
     * pause/resume and allocation states.
     * <p/>
     * <PRE> if (synth.testEngineState(Synthesizer.QUEUE_EMPTY)) ... </PRE>
     * <p/>
     * <p>The <code>testEngineState</code> method is equivalent to:
     * <p/>
     * <PRE> if ((engine.getEngineState() & state) == state) </PRE>
     * <p/>
     * <p>The <code>testEngineState</code> method can be called successfully in any <code>Engine</code> state.
     *
     * @param state a bitmask of the states to test for
     * @return <code>true</code> if this <code>Engine</code> matches <code>state</code>; otherwise <code>false</code>
     * @throws IllegalArgumentException if the specified state is unreachable
     */
    ...
    /**
     * Updates this <code>Engine</code> state by clearing defined bits, then setting other specified bits.
     *
    ...
    /**
     * Allocates the resources required for this <code>Engine</code> and puts it into the <code>ALLOCATED</code> state.
     * When this method returns successfully the <code>ALLOCATED</code> bit of this <code>Engine</code> state is set,
     * and the <code>testEngineState(Engine.ALLOCATED)</code> method returns <code>true</code>.
     * <p/>
     * <p>During the processing of the method, this <code>Engine</code> is temporarily in the
     * <code>ALLOCATING_RESOURCES</code> state.
     *
     * @throws EngineException  if this <code>Engine</code> cannot be allocated
     * @throws EngineStateError if this <code>Engine</code> is in the <code>DEALLOCATING_RESOURCES</code> state
     * @see #deallocate
     */
    ...
    /**
     * Called from the <code>allocate</code> method.  Override this in subclasses.
     *
    ...
    /**
     * Frees the resources of this <code>Engine</code> that were acquired during allocation and during operation and
     * return this <code>Engine</code> to the <code>DEALLOCATED</code>.  When this method returns the
     * <code>DEALLOCATED</code> bit of this <code>Engine</code> state is set so the
     * <code>testEngineState(Engine.DEALLOCATED)</code> method returns <code>true</code>.
     * <p/>
     * <p>During the processing of the method, this <code>Engine</code> is temporarily in the
     * <code>DEALLOCATING_RESOURCES</code> state.
     * <p/>
     * <p>A deallocated engine can be re-started with a subsequent call to <code>allocate</code>.
     *
     * @throws EngineException  if this <code>Engine</code> cannot be deallocated
     * @throws EngineStateError if this <code>Engine</code> is in the <code>ALLOCATING_RESOURCES</code> state
     * @see #allocate
     */
    ...
    /**
     * Called from the <code>deallocate</code> method.  Override this in subclasses.
     *
     * @throws EngineException if this <code>Engine</code> cannot be deallocated.
     */
    ...
    /**
     * Pauses the audio stream for this <code>Engine</code> and put this <code>Engine</code> into the
     * <code>PAUSED</code> state.
     *
     * @throws EngineStateError if this <code>Engine</code> is in the <code>DEALLOCATING_RESOURCES</code> or
    ...
    /**
     * Resumes the audio stream for this <code>Engine</code> and put this <code>Engine</code> into the
     * <code>RESUMED</code> state.
     *
    ...
    /**
     * Returns an object that provides management of the audio input or output of this <code>Engine</code>.
     *
    ...
    /**
     * Returns an object that provides management of the vocabulary for this <code>Engine</code>.  Returns
     * <code>null</code> if this <code>Engine</code> does not support vocabulary management.
     *
     * @return the vocabulary manager of this <code>Engine</code>
     * @throws EngineStateError if this <code>Engine</code> in the <code>DEALLOCATING_RESOURCES</code> or
     *                          <code>DEALLOCATED</code> state
     */
    ...
    /**
     * Gets the <code>EngineProperties</code> of this <code>Engine</code>. Must be set in subclasses.
     *
    ...
    /**
     * Gets the current operating properties and mode of this <code>Engine</code>.
     *
    ...
    /**
     * Sets the current operating properties and mode of this <code>Engine</code>.
     *
    ...
    /**
     * Requests notification of <code>EngineEvents</code> from this <code>Engine</code>.
     *
    ...
    /**
     * Removes an <code>EngineListener</code> from the list of <code>EngineListeners</code>.
     *
    ...
    /**
     * Utility function that generates an <code>ENGINE_ALLOCATED</code> event and posts it to the event queue.
     * Eventually <code>fireEngineAllocated</code> will be called by the <code>dispatchSpeechEvent</code> as a result of
     * this action.
     *
    ...
    /**
     * Utility function that sends an <code>ENGINE_ALLOCATED</code> event to all <code>EngineListeners</code> registered
     * with this <code>Engine</code>.  Called by <code>dispatchSpeechEvent</code>.
     *
    ...
    /**
     * Utility function that generates an <code>ENGINE_ALLOCATING_RESOURCES</code> event and posts it to the event
     * queue.  Eventually <code>fireEngineAllocatingResources</code> will be called by <code>dispatchSpeechEvent</code>
    ...
    /**
     * Utility function that sends an <code>ENGINE_ALLOCATING_RESOURCES</code> event to all <code>EngineListeners</code>
     * registered with this <code>Engine</code>.  Called by <code>dispatchSpeechEvent</code>.
     *
    ...
    /**
     * Utility function that generates an <code>ENGINE_DEALLOCATED</code> event and posts it to the event queue.
     * Eventually <code>fireEngineDeallocated</code> will be called by <code>dispatchSpeechEvent</code> as a result of
     * this action.
     *
     * @param oldState the old state of this <code>Engine</code>
     * @param newState the new state of this <code>Engine</code>
    ...
    /**
     * Utility function that sends an <code>ENGINE_DEALLOCATED</code> event to all <code>EngineListeners</code>
     * registered with this <code>Engine</code>.  Called by <code>dispatchSpeechEvent</code>.
     *
    ...
    /**
     * Utility function that generates <code>ENGINE_DEALLOCATING_RESOURCES</code> event and posts it to the event queue.
     * Eventually <code>fireEngineAllocatingResources</code> will be called by <code>dispatchSpeechEvent</code> as a
    ...
    /**
     * Utility function that sends a <code>ENGINE_DEALLOCATING_RESOURCES</code> event to all
     * <code>EngineListeners</code> registered with this <code>Engine</code>.  Called by
     * <code>dispatchSpeechEvent</code>.
     *
    ...
    /**
     * Utility function that generates an <code>ENGINE_PAUSED</code> event and posts it to the event queue.  Eventually
     * <code>fireEnginePaused</code> will be called by <code>dispatchSpeechEvent</code> as a result of this action.
     *
     * @param oldState the old state of this <code>Engine</code>
     * @param newState the new state of this <code>Engine</code>
    ...
    /**
     * Utility function that sends an <code>ENGINE_PAUSED</code> event to all <code>EngineListeners</code> registered
     * with this <code>Engine</code>.  Called by <code>dispatchSpeechEvent</code>.
     *
    ...
    /**
     * Utility function that generates an <code>ENGINE_RESUMED</code> event and posts it to the event queue.  Eventually
     * <code>fireEngineResumed</code> will be called by <code>dispatchSpeechEvent</code> as a result of this action.
     *
     * @param oldState the old state of this <code>Engine</code>
     * @param newState the new state of this <code>Engine</code>
    ...
    /**
     * Utility function that sends an <code>ENGINE_RESUMED</code> event to all <code>EngineListeners</code> registered
     * with this <code>Engine</code>.  Called by <code>dispatchSpeechEvent</code>.
     *
     ...
     *
     * @return a <code>BaseEngineProperties</code> object specific to a subclass.
     */
    abstract protected BaseEngineProperties createEngineProperties();


    /**
     * Convenience method that throws an <code>EngineStateError</code> if any of the bits in the passed state are set in
     * the <code>state</code>.
     *
    ...
    /**
     * Returns a <code>String</code> of the names of all the <code>Engine</code> states in the given <code>Engine</code>
     * state.
     *
    ...
    /**
     * Dispatches a <code>SpeechEvent</code>. The dispatcher should notify all <code>EngineListeners</code> from this
     * method.  The <code>SpeechEvent</code> was added via the various post methods of this class.
     *
