...
/**
 * Simple extension of RuleName to store hidden resolved rule name.
 *
...
public class BaseRuleName extends RuleName {
    ...
    /** Fully-qualified rule name generated by linkGrammars method. */
    ...
    /**
     * Copy the input rule object but change all instances of a RuleName to a BaseRuleName.  Used by setRule method in
     * BaseRuleGrammar so there is a place to put the fully resolved rule name when linking a Grammar.
     */
