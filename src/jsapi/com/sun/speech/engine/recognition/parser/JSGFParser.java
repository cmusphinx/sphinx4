  ...
  final public RuleAlternatives alternatives() throws ParseException {
    ...
    case 34:
      ...
      while (true) {
        ...
        r = sequence();
                    ...
                    if (cnt >= wa.length) {
                        wa = Arrays.copyOf(wa, wa.length + 25);
                    }
                    wa[cnt++] = w;
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case 33:
    ...
    default:
      ...
      throw new ParseException();
        ...
        RuleAlternatives ra = new RuleAlternatives(ruleList.toArray(new Rule[ruleList.size()]));
        if (cnt != 0) {
            try {
                ra.setWeights(Arrays.copyOf(wa, cnt));
            } catch (IllegalArgumentException e) {
  ...
  final public RuleSequence sequence() throws ParseException {
    ...
    while (true) {
      ...
      default:
        ...
        {if (true) return new RuleSequence(ruleList.toArray(new Rule[ruleList.size()]));}
    throw new Error("Missing return statement in function");
  }
