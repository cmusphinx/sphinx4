...
public class BaseRuleGrammar extends BaseGrammar implements RuleGrammar, Serializable {
     ...
     */ 
     public JSGFRule convert (Rule rule) {
    	...
    	if (rule instanceof RuleCount) {
    		...
    		return new JSGFRuleCount(convert (ruleCount.getRule()), ruleCount.getCount());
    	}
    ...
    /* Recursively go through the rules and create the same structures for
     * JSAPI 
     */
    ...
    public RuleParse parse(String text, String ruleName) throws GrammarException {
        return RuleParser.parse(text, recognizer, this, ruleName == null ? ruleName : JSGFRuleName.stripRuleName(ruleName));
    }
    ...
    public RuleParse parse(String tokens[], String ruleName) throws GrammarException {
        return RuleParser.parse(tokens, recognizer, this, ruleName == null ? ruleName : JSGFRuleName.stripRuleName(ruleName));
    }
