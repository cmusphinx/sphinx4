...
public class Model implements AcousticModel, Configurable {
    ...
    transient private Map compositeSenoneSequenceCache = new FastMap();
     ...
     *
     * @throws java.io.IOException if the model could not be loaded
     *
     */
    ...
    */
    ...
    // collect all senone sequences that match the pattern
     ...
     for (int i = 0; i < longestSequence; i++) {
         Set compositeSenoneSet = new FastSet();
