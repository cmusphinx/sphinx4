...
import edu.cmu.sphinx.linguist.util.LinguistTimer;
 ...
 */
public class FlatLinguist implements  Linguist {
    ...
    public final static String PROP_DUMP_GSTATES =
        "edu.cmu.sphinx.decoder.linguist.simple.FlatLinguist.dumpGstates";
    ...
    protected void setAcousticModels(AcousticModel[] models) {
        ...
        assert    this.acousticModel.getLeftContextSize() == 1
               ...
               "FlatLinguist requires left and right AM context size of 1";
    }
