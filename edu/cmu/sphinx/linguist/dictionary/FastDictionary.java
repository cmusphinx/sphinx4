...
public class FastDictionary implements Dictionary {
    ...
    private static Logger logger =
        Logger.getLogger("edu.cmu.sphinx.linguist.dictionary.FastDictionary");
     ...
     * properties: <pre>
     * edu.cmu.sphinx.linguist.dictionary.Dictionary.dictionaryPath
     * edu.cmu.sphinx.linguist.dictionary.Dictionary.fillerDictionaryPath 
     * </pre>
     *
