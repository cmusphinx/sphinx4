 ...
 * A generic graph edge must have a list of edges
 * a list of nodes
 * and an identifier.
 */

public class SentenceHMMGraph implements Graph {
    ...
    public Edge linkNodes(Node sourceNode, Node destinationNode){
        Edge newLink = new SentenceHMMEdge(sourceNode, destinationNode);
