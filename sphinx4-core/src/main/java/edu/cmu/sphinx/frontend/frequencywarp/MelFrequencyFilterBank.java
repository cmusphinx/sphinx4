...
public class MelFrequencyFilterBank extends BaseDataProcessor {
    ...
    private MelFilter[] filters;

    public MelFrequencyFilterBank(double minFreq, double maxFreq,
            int numberFilters) {
        initLogger();
        ...
        throws IllegalArgumentException
    {
        ...
        filters = new MelFilter[numberFilters];
        ...
        for (int i = 0; i < numberFilters; i++) {
            ...
            filters[i] = new MelFilter(centerMel, deltaFreqMel, melPoints);
        }
    }
