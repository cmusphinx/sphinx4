 ...
 * 
 * The Cepstrum is computed using a pipeline of front end components which are
 ...
 * 
 * A typical legacy MFCC Cepstrum will use a MelFrequencyFilterBank, followed by
 * a DiscreteCosineTransform.
 * 
 * A typical denoised MFCC Cepstrum will use a MelFrequencyFilterBank, followed
 * by a Denoise component, followed by a DiscreteCosineTransform2, followed by a
 * Lifter component.
 * 
 * The MelFrequencyFilterBank parameters (numberFilters, minimumFrequency and
...
public class AutoCepstrum extends BaseDataProcessor {
     ...
     * location in the configuration file. The Cepstrum will be configured based
     * on the feat.params file that will be found in the specified AM location.
     */
     ...
     */
    protected MelFrequencyFilterBank filterBank;

    /**
     * The denoise component which could be used for creating the cepstrum. The
     * denoise component is inserted in the pipeline only if "-remove_noise yes"
     * is specified in the feat.params file of the target acoustic model.
     */
     ...
     * cepstrum.
     * 
     * If "-transform legacy" is specified in the feat.params file of the target
     * acoustic model or if the "-transform" parameter does not appear in this
     * file at all, the legacy DCT component is inserted in the pipeline.
     * 
     * If "-transform dct" is specified in the feat.params file of the target
     * acoustic model, then the current DCT component is inserted in the
     * pipeline.
     */
    ...
    /**
     * Returns the processed Data output, basically calls <code>getData()</code>
    ...
    /**
     * Returns a description of this Cepstrum component in the format: <cepstrum
     * name> {<DataProcessor1>, <DataProcessor2> ... <DataProcessorN>}
     * 
