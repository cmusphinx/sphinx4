 ...
 *
 * The {@link MelFrequencyFilterBank} creates mel-filters and filters spectrum
 ...
 * <code>deltaFreq</code> are given to the {@link MelFilter Constructor}. The
...
public class MelFilter {
    ...
    public MelFilter(double center, double delta, double[] melPoints) {
        int lastIndex = 0;
        ...
        offset = firstIndex;
        weights = Arrays.copyOfRange(heights, firstIndex, lastIndex + 1);
    }
