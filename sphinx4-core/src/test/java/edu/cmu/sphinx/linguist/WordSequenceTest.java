...
public class WordSequenceTest {
    ...
    public void setUp() throws IOException {
        ...
        dictionary = new FullDictionary(dictUrl,
                                        noiseDictUrl,
                                        null,
                                        false,
                                        null,
    ...
    public void getNewest() {
        ...
        assertThat(ws.getNewest().getOldest(),
                   equalTo(ws.getOldest().getNewest()));
    }

    @Test
    public void unknownWords() {
        assertThat(new WordSequence(Word.UNKNOWN),
                   equalTo(new WordSequence(Word.UNKNOWN)));
