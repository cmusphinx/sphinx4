...
public class JSGFParser implements JSGFParserConstants {
  ...
  static final public RuleGrammar GrammarUnit(Recognizer R) throws ParseException {
  RuleGrammar G = null;
  ...
  static final public RuleGrammar GrammarDeclaration(Recognizer R) throws ParseException {
 String s;
 RuleGrammar G = null;
 Token t = null;
  ...
  static final public void IdentHeader() throws ParseException {
  ...
  static final public void ImportDeclaration(RuleGrammar G) throws ParseException {
 boolean all = false;
 String name;
 Token t = null;
 ...
 StringBuffer sb = new StringBuffer();
  ...
  static final public void RuleDeclaration(RuleGrammar G) throws ParseException {
 boolean pub = false;
 String s;
 Rule r;
 Token t = null;
 Token t1 = null;
  ...
  static final public RuleAlternatives alternatives() throws ParseException {
 ...
 int cnt=0;
  ...
  static final public String ruleDef() throws ParseException {
 Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IDENTIFIER:
  ...
  static final public RuleSequence sequence() throws ParseException {
 Rule r;
 Vector v = new Vector();
    label_6:
    while (true) {
  ...
  static final public float weight() throws ParseException {
 Token t;
 float f;
    jj_consume_token(34);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public Rule item() throws ParseException {
 Rule r;
 Vector t = null;
 int count=-1;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public Vector tag() throws ParseException {
  Token t;
  Vector v = new Vector();
    label_7:
    while (true) {
  ...
  static final public Rule terminal() throws ParseException {
 Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IDENTIFIER:
      t = jj_consume_token(IDENTIFIER);
  ...
  static final public RuleName ruleRef() throws ParseException {
 String s;
    jj_consume_token(28);
    s = Name();
    jj_consume_token(31);
  ...
  static final public RuleName importRef() throws ParseException {
 String s;
 boolean all = false;
    jj_consume_token(28);
    s = Name();
  ...
  static public JSGFParserTokenManager token_source;
  ...
  static final private int[] jj_la1_0 = {0x800000,0x4000,0x10008000,0x800000,0x800000,0x20000000,0x80e000,0x8000,0x0,0x0,0x10a1e000,0x81e000,0x10a1e000,0x50000,0x10a1e000,0x40000000,0x40000000,0x400000,0x40000000,0x40000000,0x400000,0x400000,0x10a1e000,0x400000,0xa1e000,0x20000000,};
  static final private int[] jj_la1_1 = {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x2,0x54,0x0,0x50,0x0,0x0,0x8,0x8,0x0,0x8,0x8,0x0,0x0,0x50,0x0,0x0,0x0,};
  ...
  static private void jj_add_error_token(int kind, int pos) {
    ...
    if (pos == jj_endpos + 1) {
      ...
      for (java.util.Enumeration enuum = jj_expentries.elements(); enuum.hasMoreElements();) {
        int[] oldentry = (int[])(enuum.nextElement());
